...
let data = {
    ...
    "wayfarer": [
        {
            "id": "4",
            "img": require('../assets/Frapp-03.png')
        },
        {
            "id": "5",
            "img": require('../assets/Frapp-04.png')
        }
    ],
    "rimless": [
        {
            "id": "10",
            "img": require('../assets/Frapp-09.png')
        }
    ],
    "round": [
        {
            "id": "2",
            "img": require('../assets/glasses-round.png')
        },
        {
            "id": "3",
            "img": require('../assets/Frapp-02.png')
        }
    ],
    "aviator": [
        {
            "id": "6",
            "img": require('../assets/Frapp-05.png')
        },
        {
            "id": "7",
            "img": require('../assets/Frapp-06.png')
        },
        {
            "id": "8",
            "img": require('../assets/Frapp-07.png')
        }
    ]
};
                    ...
                    >
                        {
                            data[this.state.selected].map(filterData => {
                                return (
                                    ...
                                    >
                                        <Image source={filterData.img} style={{ width: 32, height: 32 }} />
                                    </TouchableOpacity>
                                )
                            })
                        }
